...
public class reternal extends variableinital {
	public static void main(String[] args) {
		...
		byte bVal2 = 0;
		byte bVal3 = 127;
		//byte bVal4 = 500;  오류해결 -> 데이터 타입변경 
		int bVal4 = 500;
		
		// long
		
//		long 1Val = 10;
//		// int가 가지는 범위를 넘어서 long에 넣게되면, long 타입이라고 함
//		long 1Val2 = 100000000;
		...
		// 실수 타입
		// float
		float fVal = 3.14f;  //float fVal = 3.14;  하면 오류
		// double
		double dVal = 31.4;
